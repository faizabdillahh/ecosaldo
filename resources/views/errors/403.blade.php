...
<html lang="id">
<head>
    <x-seo title="403 - Akses Ditolak | EcoSaldo" description="Anda tidak memiliki izin untuk mengakses halaman ini." />
    <meta charset="UTF-8">
...
<body class="bg-gray-50 antialiased">
    <div class="min-h-screen flex items-center justify-center px-4">
        <div class="text-center">
            <div class="text-7xl font-extrabold text-warning mb-4">403</div>
